...
var _renderFragment = __webpack_require__(76);
...
var Order = function (_React$PureComponent) {
  ...
  function Order() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Order.__proto__ || Object.getPrototypeOf(Order)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      showModeCourier: false
    }, _this.setShowModeCourier = function () {
      if (!_this.state.showModeCourier) {
        _this.setState({ showModeCourier: true });
      } else {
        _this.setState({ showModeCourier: false });
      }
  ...
  _createClass(Order, [{
    ...
    value: function render() {
      ...
      var orderStatus = this.props.details.statusCompleted;

      return _react2.default.createElement(
        _renderFragment2.default,
        null,
        this.props.mode === 'meneger' && _react2.default.createElement(
          'tr',
          null,
          ...
          _react2.default.createElement(
            'td',
            null,
            this.props.details.quantity
          ),
          _react2.default.createElement(
            'td',
            null,
            this.props.details.clientName
          ),
          _react2.default.createElement(
            'td',
            null,
            this.props.details.adress
          ),
          _react2.default.createElement(
            'td',
            null,
            this.props.details.card ? 'Карта' : 'Наличные'
          ),
          _react2.default.createElement(
            'td',
            { className: this.props.details.statusCompleted ? 'complited' : null },
            this.props.details.statusCompleted ? 'Выполнен' : 'Не выполен'
          ),
          _react2.default.createElement(
            'td',
            null,
        ...
        this.props.mode === 'logistics' && _react2.default.createElement(
          'tr',
          null,
          _react2.default.createElement(
            'td',
          ...
          _react2.default.createElement(
            'td',
            { className: this.props.details.courier === null ? null : 'appointed' },
            this.props.details.courier === null ? 'Не назначен' : this.props.details.courier
          ),
          _react2.default.createElement(
            'td',
            { className: this.props.details.statusCompleted ? 'complited' : null },
        ...
        this.props.mode === 'courier' && _react2.default.createElement(
          _renderFragment2.default,
          null,
          _react2.default.createElement(
            'b',
          ...
          _react2.default.createElement(
            'span',
            { className: orderStatus ? 'complited' : 'incompiled' },
            orderStatus ? 'Выполнен' : 'Не выполнен'
          ),
          ' ',
          _react2.default.createElement(
            'button',
            { onClick: this.setShowModeCourier },
            this.state.showModeCourier ? 'Скрыть' : 'Детали'
          ),
          ' ',
          _react2.default.createElement('br', null),
          this.state.showModeCourier ? _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement('br', null),
            _react2.default.createElement(
            ...
            ' ',
            this.props.details.price * this.props.details.quantity + ' $',
            ' ',
            _react2.default.createElement('br', null),
            _react2.default.createElement(
              'b',
...
var ORDERS_LOADING = 'ORDERS_LOADING';
var ORDERS_ERROR = 'ORDERS_ERROR';
var ORDERS_SET = 'ORDERS_SET';

var ordersLoadingAC = function ordersLoadingAC() {
  return {
    type: ORDERS_LOADING
  };
};

var ordersErrorAC = function ordersErrorAC() {
  return {
    type: ORDERS_ERROR
  };
};

var ordersSetAC = function ordersSetAC(orders) {
  return {
    type: ORDERS_SET,
    orders: orders
  };
...
exports.ordersLoadingAC = ordersLoadingAC;
exports.ORDERS_LOADING = ORDERS_LOADING;
exports.ordersErrorAC = ordersErrorAC;
exports.ORDERS_ERROR = ORDERS_ERROR;
exports.ordersSetAC = ordersSetAC;
exports.ORDERS_SET = ORDERS_SET;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(42);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(24),A=__webpack_require__(4),B=__webpack_require__(2),ca=__webpack_require__(25),da=__webpack_require__(26),ea=__webpack_require__(27),ha=__webpack_require__(28),ia=__webpack_require__(29),C=__webpack_require__(6);
...
var combinedReducer = (0, _redux.combineReducers)({
    orders: _Reducer2.default // редьюсер oredrsReducer отвечает за раздел state под именем orders
    // + другие редьюсеры
});
...
var _ordersAC = __webpack_require__(30);
...
var _Meneger = __webpack_require__(74);

var _Meneger2 = _interopRequireDefault(_Meneger);

var _Logistics = __webpack_require__(77);

var _Logistics2 = _interopRequireDefault(_Logistics);

var _Courier = __webpack_require__(79);
...
var MainPage = function (_React$PureComponent) {
  ...
  _createClass(MainPage, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.dispatch((0, _ordersAC.ordersLoadingAC)()); // переводим раздел countries стора в состояние "загружается"
      ...
      fetch(ajaxHandlerScript, { method: 'post', body: sp }).then(function (response) {
        ...
        _this2.props.dispatch((0, _ordersAC.ordersSetAC)(JSON.parse(data.result))); // переводим раздел countries стора в состояние "ошибка"
      }).catch(function (error) {
        console.error(error);
        _this2.props.dispatch((0, _ordersAC.ordersErrorAC)()); // переводим раздел countries стора в состояние "ошибка"
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      if (this.props.orders.status <= 1) return "загрузка данных...";

      if (this.props.orders.status === 2) return "ошибка загрузки данных";

      var ordersList = this.props.orders.data;

      var ordersListForVadim = [];
      var ordersListForAlex = [];

      if (ordersList !== null) {
        ordersList.orders.forEach(function (v) {
          if (v.courier === "Вадим") {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Meneger2.default, { mode: 'meneger', ordersList: ordersList.orders }),
        _react2.default.createElement(_Logistics2.default, { mode: 'logistics', ordersList: ordersList.orders }),
        _react2.default.createElement(_Courier2.default, { courierName: 'Вадим', mode: 'courier', ordersList: ordersListForVadim }),
        _react2.default.createElement(_Courier2.default, { courierName: 'Алексей', mode: 'courier', ordersList: ordersListForAlex })
      );
    }
  }]);
...
MainPage.propTypes = {
  orders: _propTypes2.default.object.isRequired
};
...
var Meneger = function (_React$PureComponent) {
  _inherits(Meneger, _React$PureComponent);
  ...
  function Meneger() {
    ...
    _classCallCheck(this, Meneger);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Meneger.__proto__ || Object.getPrototypeOf(Meneger)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ordersList: _this.props.ordersList
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(Meneger, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
      ...
      var ordersList = this.state.ordersList.map(function (i) {
        return _react2.default.createElement(_Order2.default, { mode: _this2.props.mode, couriers: _this2.props.couriers, details: i, key: i.code });
      });
...
Meneger.PropTypes = {
  ordersList: _propTypes2.default.array.isRequired,
...
var Logistics = function (_React$PureComponent) {
  _inherits(Logistics, _React$PureComponent);
  ...
  function Logistics() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Logistics.__proto__ || Object.getPrototypeOf(Logistics)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ordersList: _this.props.ordersList,
      orderStatus: 'all'
    }, _this.showAll = function () {
      _this.setState({ orderStatus: 'all' });
    }, _this.showAssigned = function () {
      _this.setState({ orderStatus: 'assigned' });
    }, _this.showNotAssigned = function () {
      _this.setState({ orderStatus: 'notAssigned' });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Logistics, [{
    ...
    value: function render() {
      ...
      var ordersList = this.state.ordersList.map(function (i) {
        if (_this2.state.orderStatus === 'all' || _this2.state.orderStatus === 'notAssigned' && i.courier === null || _this2.state.orderStatus === 'assigned' && i.courier !== null) return _react2.default.createElement(_Order2.default, { mode: _this2.props.mode, details: i, key: i.code });
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { onClick: this.showAssigned },
            '\u041D\u0430\u0437\u043D\u0430\u0447\u0435\u043D\u043D\u044B\u0435'
          ),
          _react2.default.createElement(
            'button',
            { onClick: this.showNotAssigned },
            '\u041D\u0435 \u043D\u0430\u0437\u043D\u0430\u0447\u0435\u043D\u043D\u044B\u043D'
          )
        ),
        _react2.default.createElement('br', null),
        ...
        _react2.default.createElement(
          'button',
          null,
          '\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u043D\u0430\u0437\u043D\u0430\u0447\u0435\u043D\u043D\u044B\u0435 \u0437\u0430\u043A\u0430\u0437\u044B \u043A\u0443\u0440\u044C\u0435\u0440\u0430\u043C'
        ),
        _react2.default.createElement('hr', null)
      );
    }
...
var Courier = function (_React$PureComponent) {
  _inherits(Courier, _React$PureComponent);
  ...
  function Courier() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Courier.__proto__ || Object.getPrototypeOf(Courier)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ordersList: _this.props.ordersList,
      showOrderStats: 'all'
    }, _this.showAll = function () {
      _this.setState({ showOrderStats: 'all' });
    }, _this.showIncomplete = function () {
      _this.setState({ showOrderStats: 'Incomplete' });
    }, _this.showCompleted = function () {
      _this.setState({ showOrderStats: 'complited' });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Courier, [{
    ...
    value: function render() {
      ...
      var ordersList = this.state.ordersList.map(function (i) {
        if (_this2.state.showOrderStats === 'all' || _this2.state.showOrderStats === 'Incomplete' && i.statusCompleted !== true || _this2.state.showOrderStats === 'complited' && i.statusCompleted === true) return _react2.default.createElement(_Order2.default, { mode: _this2.props.mode, couriers: _this2.props.couriers, details: i, key: i.code });
      });
...
Courier.PropTypes = {
  ordersList: _propTypes2.default.array.isRequired,
  courierName: _propTypes2.default.string.isRequired,
  mode: _propTypes2.default.string.isRequired
};
